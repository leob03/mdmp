...
def plot_3d_motion_with_spheres(save_path, kinematic_tree, joints, title, dataset, figsize=(3, 3), fps=120, radius=3,
                                vis_mode='default', gt_frames=[], sphere_radius=0.05):
    matplotlib.use('Agg')
